...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <!--The first input -->
             <section id="form" class="row form-row justify-content-center p-3">
                <form method="post" class="form-horizontal col-md-6 col-md-offset-3">
                    ...
                    <div class="col-sm-10">
                     ...
                     <!--The third input -->
                     <div class="form-group">
                    <label class="col-sm-2 control-label" for="input3">Email</label>
                    <div class="col-sm-10">
                    ...
                    <!--The fourth input -->
                    <div class="form-group">
                        <label for="input4" class="col-sm2 control-label">Age</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group submit-message">
                        ...
                        if(isset($_POST) & !empty($_POST)){
                            $fName = $database ->sanatize($_POST['fName']);
                            $lName = $database ->sanatize($_POST['lName']);
                            $age   = $database ->sanatize($_POST['age']);
                            $email = $database ->sanatize($_POST['email']);
